<?php
    $sql = "SELECT a.alim_descricao as 'alimento', c.cons_quantidade as 'quantidade',
            ...
            c.cons_refeicao = 'lanche_da_tarde' AND
...
?>
        <style media="screen">
            #lanche_da_tarde_titulo{
                border-bottom: 1px dotted #000;
                padding-left: 74px;
                background: url("images/snack_afternoon.png") no-repeat left bottom;
                background-size: 50px 46px;
                padding-bottom: 5px;
                padding-top: 37px;
            }
        </style>
        <h3 id="lanche_da_tarde_titulo">Lanche da Tarde</h3>
